...
abstract class $UserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String datumKreiranja});
}
...
class _$UserResponseImpl implements _UserResponse {
  _$UserResponseImpl({required this.id, required this.datumKreiranja});
  ...
  @override
  String toString() {
    return 'UserResponse(id: $id, datumKreiranja: $datumKreiranja)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, datumKreiranja);
...
abstract class _UserResponse implements UserResponse {
  factory _UserResponse(
      ...
      required final String datumKreiranja}) = _$UserResponseImpl;
